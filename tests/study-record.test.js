...
test('study record page is registered and reachable from the Me stats card', () => {
  ...
  assert.match(recordTemplate, /展开月历/)
  assert.match(recordTemplate, /周期汇总/)
  assert.match(recordTemplate, /每天记录/)
  assert.match(recordTemplate, /新学单词/)
  assert.match(recordTemplate, /跟读单词/)
  assert.match(recordTemplate, /跟读句子/)
  assert.match(recordTemplate, /小测单词/)
  assert.match(recordTemplate, /背诵单词/)
  assert.match(recordTemplate, /听力音频/)
  ...
  assert.match(recordStyle, /\.calendar-day-range/)
