...
7. 生成一键脚本时要自执行 `(async function(){ ... })()`，并用书名正则匹配当前册别，例如 `/三下|三年级下/`。
...
- 来源 PDF：`/Users/zhong/Downloads/16765054.pdf`
- 生成脚本：`python3 scripts/build-yilin-3b-cms.py`
- 对照参考：`data/textbooks/yilin-3a-2024-cms/`
