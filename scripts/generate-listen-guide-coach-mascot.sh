...
PROMPT="Listen-page follow-read guide coach mascot. Match the EXACT homepage jelly monster identity from toast-hint reference: same translucent lime-green jelly slime body with tiny internal bubbles, glossy wet highlights, yellow ridged horns, premium Pixar-like 3D mobile-learning mascot. Face must match toast-hint exactly: large round shiny black eyes with bright catchlights, thick dark green eyebrows, wide happy open smile with small upper teeth and pink tongue. NO round glasses, NO white eyeglasses, NO pointing finger, NO open-palm wave, NO cupped-ear listening pose, NO seated legs-forward pose. Coach pose only: compact upright jelly blob with soft wavy liquid bottom edge, body slightly leaning forward. Right stubby hand holding a tiny cute round lime-green jelly microphone near mouth like a pronunciation coach; left stubby arm bent with a small encouraging fist pump near chest. Excited coaching expression, facing slightly toward viewer. Single character centered. No boy, no girl, no campus, no text, no UI card, no floor shadow. Flat solid pure magenta background exactly #ff00ff with no gradient. CRITICAL FRAMING: character occupies at most 58% of canvas; leave at least 20% empty safe margin on every side; horns, microphone, fists, and jelly base fully visible with no clipping. Square composition, crisp edges for mobile UI downscale."
