#!/usr/bin/env python3
"""Build today-summary header icon from source art."""
...
SOURCE_NAME = "icon-today-summary-jelly-source.png"
OUTPUT_NAME = "icon-today-summary-jelly.png"
TEXTBOOK_ICON = HOME_DIR / "icon-today-textbook-sync.png"
PADDING = 8
...
def main():
    ...
    if not TEXTBOOK_ICON.exists():
        raise FileNotFoundError(f"missing size reference: {TEXTBOOK_ICON}")

    from PIL import Image

    icon_size = Image.open(TEXTBOOK_ICON).size[0]
