#!/usr/bin/env bash
# Generate advertisement stat icons via imagegen, then build 96px PNGs.
...
PROMPTS="$ROOT/tmp/imagegen/ad-stat-icon-prompts.jsonl"
OUT_DIR="$ROOT/assets"
...
python3 "$ROOT/scripts/build-ad-jelly-assets.py" --only \
  icon-word-jelly.png \
  icon-proverb-jelly.png \
  icon-review-jelly.png
