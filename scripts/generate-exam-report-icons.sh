#!/usr/bin/env bash
# Generate exam-report page badge icons via imagegen, then build PNG assets.
...
PROMPTS="$ROOT/tmp/imagegen/exam-report-icon-prompts.jsonl"
OUT_DIR="$ROOT/assets"
...
python3 "$ROOT/scripts/build-exam-report-assets.py" "$@"
